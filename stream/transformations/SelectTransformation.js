...
module.exports = (() => {
	 ...
	 *
	 * @public
	 * @param {String[]} inputPropertyNames - The property names to select from input object.
	 * @param {String[]=} outputPropertyNames - The property names write to the output object. If omitted, the "input" property names are used.
